...
Adapted from NASA JPL [Software Lifecycle Improvement & Modernization Guides](https://nasa-ammos.github.io/slim/docs/guides/search)
...
For patch contributions, see our [Developer section](README.md#developer) in the README for more details on how to set up your local environment, to best contribute to our project.
...
3. The ability to edit, build, and test our project on your local machine. Again, see our [README.md](README.md#developer) Developer section for more details
...
- [Issue tracking system]([https://github.com/chicago-aiscience/workshop-sst/issues]) - a regularly monitored area to report issues with our software or propose changes
- [Discussion board](https://github.com/chicago-aiscience/workshop-sst/discussions) - an permanently archived place to hold conversations related to our project, and to propose as well as show+tell topics to the contributor team. This resource can be searched for old discussions.
...
Make sure people are aware you're working on a patch! Check out our [issue tracking system]([https://github.com/chicago-aiscience/workshop-sst/issues]) and find an open issue you'd like to work against, or alternatively file a new issue and mention you're working on a patch.
...
- `dev` - default branch to create feature branches from
- `test` - integrated feature branches from dev that serves a a release candidate
- `main`- released branch

### Make your Modifications

Within your local development environment, this is the stage at which you'll propose your changes, and commit those changes back to version control. See the [README.md Developer section](README.md#developer) for more specifics on what you'll need as prerequisites to setup your local development environment.
...
See our list of issues at: [https://github.com/chicago-aiscience/workshop-sst/issues]
...
Take a look at our [issue tracking system]([https://github.com/chicago-aiscience/workshop-sst/issues]), and filter by `good first issue` for issues that are low-complexity, and that will help you get familiar with our issue tracking and patch submission process.

#### Suggesting New Issue Labels

Labels within our [issue tracking system]([https://github.com/chicago-aiscience/workshop-sst/issues]) are a great way to quickly sort through tickets. The project may not yet have labels to cover the full variety of issue tickets. Take a look through our list of issues, and if you notice a set of issue tickets that seem similar but are not categorized with an existing label, go ahead submit a request within one of the issues you've looked at with the following text:
...
- **Check for duplicates** - there may be a bug report already describing your issue, so check the [issue tracking system]([https://github.com/chicago-aiscience/workshop-sst/issues]) first.

Here's some guidance on submitting a bug issue:
1. Navigate to our [issue tracking system]([https://github.com/chicago-aiscience/workshop-sst/issues]) and file a new issue
...
- **Check for duplicates** - there may be a new feature issue already describing your issue, so check the [issue tracking system]([https://github.com/chicago-aiscience/workshop-sst/issues]) first
...
⚠️ It's **highly** advised that you take a look at our [issue tracking system]([https://github.com/chicago-aiscience/workshop-sst/issues]) before considering any code contributions. Here's some guidelines:
...
⚠️ It's **highly** advised that you take a look at our [issue-tracking system]([https://github.com/chicago-aiscience/workshop-sst/issues]) before considering any documentation contributions. Here's some guidelines:
